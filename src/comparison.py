...
class CSVComparator:
    ...
    def __init__(self, key_columns: List[str], include_unchanged_columns: bool = False):
        """
    ...
    def compare(self, old_data: List[Dict[str, str]], new_data: List[Dict[str, str]]) -> List[ComparisonResult]:
        """
        ...
        old_rows = self._create_row_lookup(old_data)
        new_rows = self._create_row_lookup(new_data)
    ...
    def _create_row_lookup(self, data: List[Dict[str, str]]) -> Dict[str, Dict[str, str]]:
